...
namespace GraphEngine.ServiceFabric.RemotingClient
{
    ...
    /// </summary>
    internal sealed class RemotingClient : StatelessService
    {
        ...
        public RemotingClient(StatelessServiceContext context)
            : base(context)
        {
            m_trinity = new TrinityClient("fabric:/TrinityServiceFabric.NativeClusterRemoting.Application/GraphEngine.ServiceFabric.GraphDataService");
