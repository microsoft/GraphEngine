...
namespace Trinity.GraphEngine.ServiceFabric.Core.Interfaces
{
    class ServiceFabricPartitioner : IPartitioner
    {
        ...
        public int PartitionCount => GraphEngineStatefulServiceCore.Instance.PartitionCount;

        public int PartitionId => GraphEngineStatefulServiceCore.Instance.PartitionId;
