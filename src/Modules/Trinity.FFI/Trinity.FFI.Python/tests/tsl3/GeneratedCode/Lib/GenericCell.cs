    ...
    internal class GenericCellOperations : IGenericCellOperations
    {
        ...
        public void SaveGenericCell(Trinity.Storage.LocalMemoryStorage storage, CellAccessOptions writeAheadLogOptions, ICell cell)
        {
            switch ((CellType)cell.CellType)
            {
                ...
                case CellType.C2:
                storage.SaveC2(writeAheadLogOptions, (C2)cell);
                break;
                
                case CellType.C3:
                storage.SaveC3(writeAheadLogOptions, (C3)cell);
                break;
        ...
        public void SaveGenericCell(Trinity.Storage.LocalMemoryStorage storage, CellAccessOptions writeAheadLogOptions, long cellId, ICell cell)
        {
            switch ((CellType)cell.CellType)
            {
                ...
                case CellType.C2:
                storage.SaveC2(writeAheadLogOptions, cellId, (C2)cell);
                break;
                
                case CellType.C3:
                storage.SaveC3(writeAheadLogOptions, cellId, (C3)cell);
                break;
        ...
        public ICell NewGenericCell(string cellType)
        {
            ...
            switch (type)
            {
                ...
                case global::Trinity.Extension.CellType.C1:
                return new C1();
                break;
                
                case global::Trinity.Extension.CellType.C2:
                return new C2();
                break;
                
                case global::Trinity.Extension.CellType.C3:
                return new C3();
                break;
        ...
        public ICell NewGenericCell(long cellId, string cellType)
        {
            ...
            switch (type)
            {
                ...
                case global::Trinity.Extension.CellType.C2:
                return new C2(cell_id: cellId);
                
                case global::Trinity.Extension.CellType.C3:
                return new C3(cell_id: cellId);
        ...
        public ICell NewGenericCell(string cellType, string content)
        {
            ...
            switch (type)
            {
                ...
                case global::Trinity.Extension.CellType.C2:
                return C2.Parse(content);
                
                case global::Trinity.Extension.CellType.C3:
                return C3.Parse(content);
        ...
        public unsafe ICellAccessor UseGenericCell(Trinity.Storage.LocalMemoryStorage storage, long cellId)
        {
            ...
            switch ((CellType)type)
            {
                ...
                case CellType.C1:
                return C1_Accessor._get()._Setup(cellId, cellPtr, entryIndex, CellAccessOptions.ThrowExceptionOnCellNotFound);
                
                case CellType.C2:
                return C2_Accessor._get()._Setup(cellId, cellPtr, entryIndex, CellAccessOptions.ThrowExceptionOnCellNotFound);
                
                case CellType.C3:
                return C3_Accessor._get()._Setup(cellId, cellPtr, entryIndex, CellAccessOptions.ThrowExceptionOnCellNotFound);
        ...
        public unsafe ICellAccessor UseGenericCell(Trinity.Storage.LocalMemoryStorage storage, long cellId, CellAccessOptions options, string cellType)
        {
            switch (cellType)
            {
                ...
                case "C1": return C1_Accessor._get()._Lock(cellId, options);
                
                case "C2": return C2_Accessor._get()._Lock(cellId, options);
                
                case "C3": return C3_Accessor._get()._Lock(cellId, options);
        ...
        public IEnumerable<ICell> EnumerateGenericCells(LocalMemoryStorage storage)
        {
            foreach (var cellInfo in Global.LocalStorage)
            {
                switch ((CellType)cellInfo.CellType)
                {
                    ...
                    case CellType.C1:
                        {
                            var C1_accessor = C1_Accessor.AllocIterativeAccessor(cellInfo, null);
                    ...
                    case CellType.C2:
                        {
                            var C2_accessor = C2_Accessor.AllocIterativeAccessor(cellInfo, null);
                            var C2_cell     = (C2)C2_accessor;
                            C2_accessor.Dispose();
                            yield return C2_cell;
                            break;
                        }
                    
                    case CellType.C3:
                        {
                            var C3_accessor = C3_Accessor.AllocIterativeAccessor(cellInfo, null);
                            var C3_cell     = (C3)C3_accessor;
                            C3_accessor.Dispose();
                            yield return C3_cell;
                            break;
                        }
        ...
        public void SaveGenericCell(IKeyValueStore storage, ICell cell)
        {
            switch ((CellType)cell.CellType)
            {
                ...
                case CellType.C2:
                storage.SaveC2((C2)cell);
                break;
                
                case CellType.C3:
                storage.SaveC3((C3)cell);
                break;
        ...
        public void SaveGenericCell(IKeyValueStore storage, long cellId, ICell cell)
        {
            switch ((CellType)cell.CellType)
            {
                ...
                case CellType.C2:
                storage.SaveC2(cellId, (C2)cell);
                break;
                
                case CellType.C3:
                storage.SaveC3(cellId, (C3)cell);
                break;
        ...
        public unsafe ICellAccessor UseGenericCell(long cellId, byte* cellBuffer, int entryIndex, ushort cellType, CellAccessOptions options)
        {
            switch ((CellType)cellType)
            {
                ...
                case CellType.C1:
                return C1_Accessor._get()._Setup(cellId, cellBuffer, entryIndex, options);
                
                case CellType.C2:
                return C2_Accessor._get()._Setup(cellId, cellBuffer, entryIndex, options);
                
                case CellType.C3:
                return C3_Accessor._get()._Setup(cellId, cellBuffer, entryIndex, options);
