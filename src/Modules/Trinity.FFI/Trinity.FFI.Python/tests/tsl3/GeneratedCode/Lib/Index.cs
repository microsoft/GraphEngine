...
namespace Trinity.Extension
{
    ...
    /// The target field to query on is specified with <paramref name="query"/>, <seealso cref="Trinity.Extension.IndexIdentifier"/>.
    /// </summary>
    public class Index
    {
        static Index()
        ...
        /// instance, accessible through Trinity.Extension.Index.Target_Cell_Name.Target_Field_Name.
        /// </summary>
