...
namespace Trinity.Extension
{
    class Throw
    {
        ...
        internal static void parse_List_int(string value)
        {
            throw new ArgumentException("Cannot parse \""+value+"\" into List<int>.");
        }
        internal static void incompatible_with_List_int()
        {
            throw new DataTypeIncompatibleException("Data type 'List<int>' not compatible with the target field.");
        }
