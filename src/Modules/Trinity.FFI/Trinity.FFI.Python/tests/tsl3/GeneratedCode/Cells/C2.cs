...
namespace Trinity.Extension
{
    ...
    public partial struct C2 : ICell
    {
        ...
        ///</summary>
        public C2(long cell_id , int foo = default(int))
        {
        ...
        public IEnumerable<KeyValuePair<string, T>> SelectFields<T>(string attributeKey, string attributeValue)
        {
            switch (TypeConverter<T>.type_id)
            {
                ...
                if (StorageSchema.C2_descriptor.check_attribute(StorageSchema.C2_descriptor.foo, attributeKey, attributeValue))
    ...
    public unsafe class C2_Accessor : ICellAccessor
    {
        ...
        private static unsafe byte[] construct( int foo = default(int) )
        {
    ...
    static public class StorageExtension_C2
    {
        ...
        public unsafe static bool SaveC2(this IKeyValueStore storage, long cellId, int foo = default(int))
        {
        ...
        {
            return SaveC2(storage, cellId  , cellContent.foo );
        }
        /// <summary>
        ...
        {
            return SaveC2(storage, cellContent.CellId  , cellContent.foo );
        }
        /// <summary>
        ...
        /// <param name="options">Specifies write-ahead logging behavior. Valid values are CellAccessOptions.StrongLogAhead(default) and CellAccessOptions.WeakLogAhead. Other values are ignored.</param>
        /// <returns>true if saving succeeds; otherwise, false.</returns>
        public unsafe static bool SaveC2(this Trinity.Storage.LocalMemoryStorage storage, CellAccessOptions options, long cellId, int foo = default(int))
        {
        ...
        {
            return SaveC2(storage, options, cellId  , cellContent.foo );
        }
        /// <summary>
        /// Adds a new cell of type C2 to the key-value store if the cell Id does not exist, or updates an existing cell in the key-value store if the cell Id already exists. Cell Id is specified by the CellId field in the content object.
        /// </summary>
        ...
        {
            return SaveC2(storage, options, cellContent.CellId  , cellContent.foo );
        }
        /// <summary>
        /// Loads the content of the specified cell. Any changes done to this object are not written to the store, unless
        /// the content object is saved back into the storage.
        ...
        /// <param name="options">Specifies write-ahead logging behavior. Valid values are CellAccessOptions.StrongLogAhead(default) and CellAccessOptions.WeakLogAhead. Other values are ignored.</param>
        /// <returns>true if saving succeeds; otherwise, false.</returns>
        public unsafe static bool SaveC2(this Trinity.Storage.LocalMemoryStorage storage, LocalTransactionContext tx, CellAccessOptions options, long cellId, int foo = default(int))
        {
        ...
        {
            return SaveC2(storage, tx, options, cellId  , cellContent.foo );
        }
        /// <summary>
        /// Adds a new cell of type C2 to the key-value store if the cell Id does not exist, or updates an existing cell in the key-value store if the cell Id already exists. Cell Id is specified by the CellId field in the content object.
        /// </summary>
        ...
        {
            return SaveC2(storage, tx, options, cellContent.CellId  , cellContent.foo );
        }
        /// <summary>
        /// Loads the content of the specified cell. Any changes done to this object are not written to the store, unless
        /// the content object is saved back into the storage.
