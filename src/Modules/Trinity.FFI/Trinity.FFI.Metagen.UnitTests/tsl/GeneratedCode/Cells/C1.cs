...
namespace Trinity.Extension
{
    ...
    public partial struct C1 : ICell
    {
        ...
        ///</summary>
        public C1(long cell_id , int i = default(int))
        {
        ...
        public T GetField<T>(string fieldName)
        {
            switch (FieldLookupTable.Lookup(fieldName))
            {
                ...
                case 0:
                return TypeConverter<T>.ConvertFrom_int(this.i);
        ...
        public void SetField<T>(string fieldName, T value)
        {
            switch (FieldLookupTable.Lookup(fieldName))
            {
                ...
                case 0:
                this.i = TypeConverter<T>.ConvertTo_int(value);
                break;
        ...
        public IEnumerable<KeyValuePair<string, T>> SelectFields<T>(string attributeKey, string attributeValue)
        {
            switch (TypeConverter<T>.type_id)
            {
                ...
                if (StorageSchema.C1_descriptor.check_attribute(StorageSchema.C1_descriptor.i, attributeKey, attributeValue))
                    
                        yield return new KeyValuePair<string, T>("i", TypeConverter<T>.ConvertFrom_int(this.i));
        ...
        private IEnumerable<T> _enumerate_from_i<T>()
        {
                ...
                case 0:
                    {
                        ...
                        yield return TypeConverter<T>.ConvertFrom_int(this.i);
        ...
        public IEnumerable<T> EnumerateValues<T>(string attributeKey, string attributeValue)
        {
            ...
            if (attributeKey == null)
            {
                ...
                foreach (var val in _enumerate_from_i<T>())
                    yield return val;
    ...
    public unsafe class C1_Accessor : ICellAccessor
    {
        ...
        private static unsafe byte[] construct( int i = default(int) )
        {
        ...
        ///<summary>
        ///Provides in-place access to the object field i.
        ///</summary>
        public unsafe int i
        {
            get
    ...
    static public class StorageExtension_C1
    {
        ...
        public unsafe static bool SaveC1(this IKeyValueStore storage, long cellId, int i = default(int))
        {
        ...
        {
            return SaveC1(storage, cellId  , cellContent.i );
        }
        /// <summary>
        ...
        {
            return SaveC1(storage, cellContent.CellId  , cellContent.i );
        }
        /// <summary>
        ...
        /// <param name="options">Specifies write-ahead logging behavior. Valid values are CellAccessOptions.StrongLogAhead(default) and CellAccessOptions.WeakLogAhead. Other values are ignored.</param>
        /// <returns>true if saving succeeds; otherwise, false.</returns>
        public unsafe static bool SaveC1(this Trinity.Storage.LocalMemoryStorage storage, CellAccessOptions options, long cellId, int i = default(int))
        {
        ...
        {
            return SaveC1(storage, options, cellId  , cellContent.i );
        }
        /// <summary>
        /// Adds a new cell of type C1 to the key-value store if the cell Id does not exist, or updates an existing cell in the key-value store if the cell Id already exists. Cell Id is specified by the CellId field in the content object.
        /// </summary>
        ...
        {
            return SaveC1(storage, options, cellContent.CellId  , cellContent.i );
        }
        /// <summary>
        /// Loads the content of the specified cell. Any changes done to this object are not written to the store, unless
        /// the content object is saved back into the storage.
        ...
        /// <param name="options">Specifies write-ahead logging behavior. Valid values are CellAccessOptions.StrongLogAhead(default) and CellAccessOptions.WeakLogAhead. Other values are ignored.</param>
        /// <returns>true if saving succeeds; otherwise, false.</returns>
        public unsafe static bool SaveC1(this Trinity.Storage.LocalMemoryStorage storage, LocalTransactionContext tx, CellAccessOptions options, long cellId, int i = default(int))
        {
        ...
        {
            return SaveC1(storage, tx, options, cellId  , cellContent.i );
        }
        /// <summary>
        /// Adds a new cell of type C1 to the key-value store if the cell Id does not exist, or updates an existing cell in the key-value store if the cell Id already exists. Cell Id is specified by the CellId field in the content object.
        /// </summary>
        ...
        {
            return SaveC1(storage, tx, options, cellContent.CellId  , cellContent.i );
        }
        /// <summary>
        /// Loads the content of the specified cell. Any changes done to this object are not written to the store, unless
        /// the content object is saved back into the storage.
