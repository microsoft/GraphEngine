...
namespace Trinity.FFI
{
    public static class FFIMethods
    {
        ...
        {
			fdenum_movenext      = FieldDescriptorEnumerator.movenext,
			fdenum_fieldname     = FieldDescriptorEnumerator.fieldname,
			fdenum_fieldoptional = FieldDescriptorEnumerator.fieldoptional,
			fdenum_from_celldesc = FieldDescriptorEnumerator.from_celldesc,
