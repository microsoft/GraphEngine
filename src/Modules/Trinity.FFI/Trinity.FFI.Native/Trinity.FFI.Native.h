...
#include <cstdint>
#include <os/os.h>
#define TRINITYFFINATIVE_API __declspec(dllexport)
#else
#define TRINITYFFINATIVE_API __declspec(dllimport)
#endif
...
typedef char* TRINITY_FFI_SYNC_REGISTRY(int32_t, TRINITY_FFI_SYNC_HANDLER);
...
typedef TrinityErrorCode TRINITY_FFI_LOCAL_LOADCELL(int64_t cellId, Cell* cell);
typedef TrinityErrorCode TRINITY_FFI_CLOUD_LOADCELL(int64_t cellId, Cell* cell);
...
typedef TrinityErrorCode TRINITY_FFI_NEWCELL_1(char* cellType, Cell* cell);
typedef TrinityErrorCode TRINITY_FFI_NEWCELL_2(int64_t cellId, char* cellType, Cell* cell);
typedef TrinityErrorCode TRINITY_FFI_NEWCELL_3(char* cellType, char* cellContent, Cell* cell);
...
typedef void    TRINITY_FFI_CELL_DELETE(Cell* cell, int64_t);
