...
namespace Trinity.Extension.abc
{
    ...
    public class StorageSchema : IStorageSchema
    {
        ...
        internal static Dictionary<string, CellType> cellTypeLookupTable = new Dictionary<string, CellType>()
        {
            ...
            {"C1", global::Trinity.Extension.abc.CellType.C1}
            
        };
        #endregion
        
        internal static readonly Type   s_cellType_C1       = typeof(global::Trinity.Extension.abc.C1);
        ...
        internal class C1_descriptor : ICellDescriptor
        {
            ...
            {
                int field_id = global::Trinity.Extension.abc.C1.FieldLookupTable.Lookup(fieldName);
                if (field_id == -1)
        ...
        /// <summary>
        /// Converts a type string to <see cref="Trinity.Extension.abc.CellType"/>.
        /// </summary>
