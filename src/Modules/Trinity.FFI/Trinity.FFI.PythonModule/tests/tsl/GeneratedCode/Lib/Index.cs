...
using Trinity.Extension.abc.Linq;
namespace Trinity.Extension.abc
{
    /// <summary>
    /// Provides indexing capabilities on <see cref="Trinity.Storage.LocalMemoryStorage"/>.
    /// The target field to query on is specified with <paramref name="query"/>, <seealso cref="Trinity.Extension.abc.IndexIdentifier"/>.
    /// </summary>
    public class Index
    {
        static Index()
        ...
        /// instance, accessible through Trinity.Extension.abc.Index.Target_Cell_Name.Target_Field_Name.
        /// </summary>
