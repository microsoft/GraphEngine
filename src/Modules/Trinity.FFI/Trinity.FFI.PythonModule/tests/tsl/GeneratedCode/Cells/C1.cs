...
namespace Trinity.Extension.abc
{
    ...
    public partial struct C1 : ICell
    {
        ...
        /// is not appendable(string or list), calling this method is equivalent to <see cref="Trinity.Extension.abc.GenericCellAccessor.SetField(string, T)"/>.
        /// </summary>
        /// <typeparam name="T">
        /// The type of the value.
        /// </typeparam>
...
targetPtr += *(int*)targetPtr + sizeof(int);}
        ...
        /// If write-ahead-log behavior is specified on <see cref="Trinity.Extension.abc.StorageExtension_C1.UseC1"/>,
...
*(optheader_1 + 0) |= 0x01;
        ...
        /// <returns>A <see cref="Trinity.Extension.abc.C1"/> instance.</returns>
