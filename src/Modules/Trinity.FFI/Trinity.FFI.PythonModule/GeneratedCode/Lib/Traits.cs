...
namespace CellAssembly
{
    ...
    internal interface ITypeConverter<T>
    {
        ...
        T ConvertFrom_int_nullable(int? value);
        int? ConvertTo_int_nullable(T value);
        TypeConversionAction GetConversionActionTo_int_nullable();
        IEnumerable<int?> Enumerate_int_nullable(T value);
    ...
    internal class TypeConverter<T> : ITypeConverter<T>
    {
        ...
        
        {
            ...
            int ITypeConverter<int>.ConvertFrom_int_nullable(int? value)
            {
                
                return TypeConverter<int>.ConvertFrom_int(value.Value);
                
            }
            int? ITypeConverter<int>.ConvertTo_int_nullable(int value)
            {
                return TypeConverter<int?>.ConvertFrom_int(value);
            }
            TypeConversionAction ITypeConverter<int>.GetConversionActionTo_int_nullable()
            {
            ...
            /// ONLY VALID FOR TC_CONVERTLIST AND TC_ARRAYTOLIST.
            /// </summary>
            IEnumerable<int?> ITypeConverter<int>.Enumerate_int_nullable(int value)
            {
            ...
            string ITypeConverter<string>.ConvertFrom_int_nullable(int? value)
            {
                
                return Serializer.ToString(value);
                
            }
            int? ITypeConverter<string>.ConvertTo_int_nullable(string value)
            {
                return TypeConverter<int?>.ConvertFrom_string(value);
            }
            TypeConversionAction ITypeConverter<string>.GetConversionActionTo_int_nullable()
            {
            ...
            /// ONLY VALID FOR TC_CONVERTLIST AND TC_ARRAYTOLIST.
            /// </summary>
            IEnumerable<int?> ITypeConverter<string>.Enumerate_int_nullable(string value)
            {
            ...
            List<string> ITypeConverter<List<string>>.ConvertFrom_int_nullable(int? value)
            {
                
                {
                    List<string> intermediate_result = new List<string>();
                    intermediate_result.Add(TypeConverter<string>.ConvertFrom_int_nullable(value));
                    return intermediate_result;
                }
                
            }
            int? ITypeConverter<List<string>>.ConvertTo_int_nullable(List<string> value)
            {
                return TypeConverter<int?>.ConvertFrom_List_string(value);
            }
            TypeConversionAction ITypeConverter<List<string>>.GetConversionActionTo_int_nullable()
            {
            ...
            /// ONLY VALID FOR TC_CONVERTLIST AND TC_ARRAYTOLIST.
            /// </summary>
            IEnumerable<int?> ITypeConverter<List<string>>.Enumerate_int_nullable(List<string> value)
            {
            ...
            int ITypeConverter<int?>.ConvertTo_int(int? value)
            {
                return TypeConverter<int>.ConvertFrom_int_nullable(value);
            }
            TypeConversionAction ITypeConverter<int?>.GetConversionActionTo_int()
            {
            ...
            int? ITypeConverter<int?>.ConvertFrom_string(string value)
            {
                
                {
                    ...
                    {
                        conversion_success = ExternalParser.TryParse_int_nullable(value, out intermediate_result);
                    }
            ...
            string ITypeConverter<int?>.ConvertTo_string(int? value)
            {
                return TypeConverter<string>.ConvertFrom_int_nullable(value);
            }
            TypeConversionAction ITypeConverter<int?>.GetConversionActionTo_string()
            {
            ...
            List<string> ITypeConverter<int?>.ConvertTo_List_string(int? value)
            {
                return TypeConverter<List<string>>.ConvertFrom_int_nullable(value);
            }
            TypeConversionAction ITypeConverter<int?>.GetConversionActionTo_List_string()
            {
            ...
            object ITypeConverter<object>.ConvertFrom_int_nullable(int? value)
            {
                return value;
            }
            int? ITypeConverter<object>.ConvertTo_int_nullable(object value)
            {
                throw new NotImplementedException();
            }
            TypeConversionAction ITypeConverter<object>.GetConversionActionTo_int_nullable()
            {
                throw new NotImplementedException();
            }
            IEnumerable<int?> ITypeConverter<object>.Enumerate_int_nullable(object value)
            {
                throw new NotImplementedException();
            }
        ...
        T ITypeConverter<T>.ConvertFrom_int_nullable(int? value)
        {
            throw new NotImplementedException("Internal error T5013.");
        }
        int? ITypeConverter<T>.ConvertTo_int_nullable(T value)
        {
            throw new NotImplementedException("Internal error T5013.");
        }
        TypeConversionAction ITypeConverter<T>.GetConversionActionTo_int_nullable()
        {
            throw new NotImplementedException("Internal error T5013.");
        }
        IEnumerable<int?> ITypeConverter<T>.Enumerate_int_nullable(T value)
        {
            throw new NotImplementedException("Internal error T5013.");
        }
        ...
        internal static T ConvertFrom_int_nullable(int? value)
        {
            return s_type_converter.ConvertFrom_int_nullable(value);
        }
        internal static int? ConvertTo_int_nullable(T value)
        {
            return s_type_converter.ConvertTo_int_nullable(value);
        }
        internal static TypeConversionAction GetConversionActionTo_int_nullable()
        {
            return s_type_converter.GetConversionActionTo_int_nullable();
        }
        internal static IEnumerable<int?> Enumerate_int_nullable(T value)
        {
            return s_type_converter.Enumerate_int_nullable(value);
        }
