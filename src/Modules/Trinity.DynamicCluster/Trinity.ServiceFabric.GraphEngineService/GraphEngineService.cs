...
namespace Trinity.ServiceFabric
{
    ...
    public sealed class GraphEngineService : StatefulService
    {
        ...
        protected override IEnumerable<ServiceReplicaListener> CreateServiceReplicaListeners()
        {
            ...
            return new[] {
                new ServiceReplicaListener(ctx => new GraphEngineListener(GraphEngineRuntime), GraphEngineConstants.GraphEngineListenerName, true),
                new ServiceReplicaListener(ctx => new GraphEngineHttpListener(GraphEngineRuntime), GraphEngineConstants.GraphEngineHttpListenerName, false),
                // TODO WCF
            };
        }
