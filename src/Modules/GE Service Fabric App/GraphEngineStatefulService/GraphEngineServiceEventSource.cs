...
namespace Trinity.ServiceFabric.GraphEngineService
{
    ...
    internal sealed class GraphEngineServiceEventSource : EventSource
    {
        ...
        private string EnsureLogHeader()
        {
            ...
            if (GraphEngineStatefulServiceCore.Instance == null) return "";
            m_logheader = $"[P{GraphEngineStatefulServiceCore.Instance.PartitionId}-{Utils.GenerateNickName(NameService.GetInstanceId())}]\t";
            return m_logheader;
        }
