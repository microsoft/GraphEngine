...
source.Append(@"how to format the value of this Guid. The format parameter can be ""N"", ""D"", ""B"", ""P"", or ""X"". If format is null or an empty string (""""), ""D"" is used. </param>
        ...
        /// </summary>
        /");
source.Append(@"// <param name=""value"">The Guid instance.</param>
...
source.Append(@"ect have the same value.
        /// </summary>
