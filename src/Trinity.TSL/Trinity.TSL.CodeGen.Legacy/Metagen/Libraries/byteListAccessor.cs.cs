...
source.Append(@"t which item should be inserted.</param>
...
source.Append(@"mparison)
        ...
        {
     ");
source.Append(@"       if (index < 0 || index >= Count) throw new IndexOutOfRangeException();
            byte* targetPtr = CellPtr;
            targetPtr += index;
            int offset = (int)(targetPtr - CellPtr);
        ...
        public unsafe void AddRange(List<byte> collection)
        {
            ...
            int d");
source.Append(@"elta = tcollection.length;
        ...
        public unsafe void AddRange(byteListAccessor collection)
        {
            ...
            ");
source.Append(@"    *(int*)CellPtr += delta;
            }
            else
            {
...
source.Append(@"            {
        ...
        /// </summary>
     ");
source.Append(@"   /// <param name=""array"">The one-dimensional Array that is the destination of the elements copied from List. The Array must have zero-based indexing.</param>
        ...
        /// </summary>
        /// <param ");
source.Append(@"name=""index"">The zero-based index in the source List at which copying begins.</param>
        /// <param name=""array"">The one-dimensional Array that is the destination of the elements copied from List. The Array must have zero-based indexing.</param>
        /// <param name=""arrayIndex"">The zero-based index in array at which copying begins.</param>;
...
source.Append(@" greater than Count."");
...
source.Append(@" name=""b"" />; otherwise, false.</returns>
