...
source.Append(@"
{
    ...
    public unsafe class EnumAccessor
    {
        ...
        /// </summary>
        /// <p");
source.Append(@"aram name=""accessor"">A EnumAccessor accessor.</param>
        /// <returns>A byte.</returns>
...
source.Append(@"the same value; otherwise, false.</returns>
        ...
        /// </summary>
   ");
source.Append(@"     /// <param name=""obj"">An object to compare with this instance or null.</param>       
