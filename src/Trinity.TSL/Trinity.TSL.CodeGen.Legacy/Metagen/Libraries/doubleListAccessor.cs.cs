...
source.Append(@"ellPtr;
        ...
        /// <summary>
        /// Copie");
source.Append(@"s the elements to a new double array.
        /// </summary>
...
source.Append(@"sizeFunction(this.CellPtr - 4, offset + 4, size);
            *(int*)this.CellPtr += size;
            this.CellPtr += 4;
...
source.Append(@"            }
        ...
        /// <summary>
   ");
source.Append(@"     /// Adds the elements of the specified collection to the end of the List
        /// </summary>
...
source.Append(@"n)
        ...
        public unsafe void AddRange(double[] collection, int startIndex, int count)
        {
            ...
            int delta = count << 3;
      ");
source.Append(@"      CellPtr = ResizeFunction(CellPtr - 4, *(int*)(CellPtr - 4) + 4, delta);
...
source.Append(@"+ *(int*)CellPtr + 4, delta);
                *(int*)CellPtr += delta;
            }
            else
            {
        ...
        /// <summary>
        /// Determ");
source.Append(@"ines whether an element is in the List
        /// </summary>
...
source.Append(@"to a compatible one-dimensional array, starting at the specified index of the ptr1 array.
        /// </summary>
        /// <param name=""array"">The one-dimensional Array that is the destination of the elements copied from List. The Array must have zero-based indexing.</param>
...
source.Append(@"Count - index) throw new ArgumentException(""The number of elements from index to the end of the source List is greater than the available space from arrayIndex to the end of the destination array. "");
...
source.Append(@"      {
        ...
        ");
source.Append(@"public unsafe void RemoveRange(int index, int count)
        {
            if (index < 0) throw new ArgumentOutOfRangeException(""index is less than 0."");
            if (index > Count) throw new ArgumentOutOfRangeException(""index is greater than Count."");
...
source.Append(@"istAccessor accessor)
        {
        ...
        public unsafe static implicit operator doubleListAccessor(List<double> value)
        {
            ...
            {
                *(");
source.Append(@"int*)targetPtr = value.Count * 8;
                targetPtr += sizeof(int);
    ...
    ");
source.Append(@"    public static bool operator ==(doubleListAccessor a, doubleListAccessor b)
        {
        ...
        /// <summary>
        /// ");
source.Append(@"Determines whether this instance and a specified object have the same value.
        /// </summary>
