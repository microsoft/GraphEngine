...
source.Append(@"h has one parameter indicates char in string</param>
...
source.Append(@" value.
        ...
        /// <retur");
source.Append(@"ns>true if the value of <paramref name=""a"" /> is the same as the value of <paramref name=""b"" />; otherwise, false.</returns>
        ...
        public static bool operator !=(StringAccessor a, string b)
        {
            ...
            if (((object)a == null) || ((o");
source.Append(@"bject)b == null)) return true;
            return a.ToString() != b;
        }
        /// <summary>
     ...
     ");
source.Append(@"   /// <returns>A 32-bit signed integer hash code.</returns>
        ...
        /// <param name=""a"">The first StringAccessor to compare, or null. </param>
        /// ");
source.Append(@"<param name=""b"">The second StringAccessor to compare, or null. </param>
        public static bool operator !=(StringAccessor a, StringAccessor b)
        {
            return !(a == b);
        }
