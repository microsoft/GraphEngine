...
source.Append(@"   ///
    ...
    ");
source.Append(@"    internal DateTimeAccessor(byte* _CellPtr)
        {
            CellPtr = _CellPtr;
        }
        internal int length
...
source.Append(@"ing to current DateTimeAccessor.</returns>
        ...
        /// <summary>
        /// Re");
source.Append(@"turns a value indicating whether two given DateTimeAccessor instances have the same value.
        /// </summary>
        ...
        /// <param name=""a"">The first DateTimeAccessor instance.</param>
        /// <param name=""b"">");
source.Append(@"The second DateTimeAccessor instance.</param>
