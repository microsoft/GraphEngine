...
source.Append(@"rns>
        ...
        /// </summary>
 ");
source.Append(@"       /// <param name=""value"">The string instance.</param>
...
source.Append(@"of <paramref name=""a"" /> is the same as the value of <paramref name=""b"" />; otherwise, false.</returns>
...
source.Append(@"quals(a, b))
        ...
        /// </summary>
      ");
source.Append(@"  /// <param name=""obj"">The StringAccessor to compare to this instance.</param>
        ...
        /// <summary>D");
source.Append(@"etermines whether the two specified StringAccessor have different values.</summary>
        /// <returns>true if the value of <paramref name=""a"" /> is different from the value of <paramref name=""b"" />; otherwise, false.</returns>
        /// <param name=""a"">The first StringAccessor to compare, or null. </param>
        /// <param name=""b"">The second StringAccessor to compare, or null. </param>
        public static bool operator !=(U8StringAccessor a, U8StringAccessor b)
