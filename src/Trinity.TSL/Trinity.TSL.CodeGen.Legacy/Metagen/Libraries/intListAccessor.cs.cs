...
source.Append(@"
{
    ...
    public unsafe class intListAccessor : IEnumerable<int>
    {
        ...
        /// </summary>
        /");
source.Append(@"// <param name=""index"">Given index</param>
        ...
        /// </summary>
        /// <param name=""action"">A lambda expression which has one parameter indi");
source.Append(@"cates element in List</param>
...
source.Append(@"     it.move_next();
        ...
        /// </summary>
        /// <param name=""index"">The zero-based index at which item should be inse");
source.Append(@"rted.</param>
...
source.Append(@"= sizeof(int);
        ...
        {
            if (index < 0 || index >= ");
source.Append(@"Count) throw new IndexOutOfRangeException();
            byte* targetPtr = CellPtr + (index << 2);
            int offset = (int)(targetPtr - CellPtr);
            int size = -sizeof(int);
            this.CellPtr = this.ResizeFunction(this.CellPtr - 4, offset + 4, size);
        ...
        public unsafe void AddRange(List<int> collection)
        {
            ...
            Memory.Copy(tcolle");
source.Append(@"ction.CellPtr, CellPtr + *(int*)CellPtr + 4, delta);
            *(int*)CellPtr += delta;
            this.CellPtr += 4;
        }
        /// <summary>
        ...
        public unsafe void AddRange(intListAccessor collection)
        {
            ...
            else
            {
               ...
               ");
source.Append(@" fixed (byte* tmpcellptr = tmpcell)
                {
        ...
        /");
source.Append(@"// <returns>true if item is found in the List; otherwise, false.</returns>
        ...
        /// <summary>
        /// ");
source.Append(@"Copies the entire List to a compatible one-dimensional array, starting at the beginning of the ptr1 array.
        /// </summary>
...
source.Append(@" the elements copied from List. The Array must have zero-based indexing.</param>
        ...
        /// </summary>
        /// <param name=""index""");
source.Append(@">The zero-based index in the source List at which copying begins.</param>
        /// <param name=""array"">The one-dimensional Array that is the destination of the elements copied from List. The Array must have zero-based indexing.</param>
        /// <param name=""arrayIndex"">The zero-based index in array at which copying begins.</param>;
      ...
      ");
source.Append(@"      if (index >= Count) throw new ArgumentException(""index is equal to or greater than the Count of the source List."");
            fixed (int* ip = array)
            {
        ...
        public unsafe void InsertRange(int index, List<int> collection)
        {
            ...
            if (inde");
source.Append(@"x > Count) throw new ArgumentOutOfRangeException(""index is greater than Count."");
        ...
        public unsafe void RemoveRange(int index, int count)
        {
            ...
            if (index + co");
source.Append(@"unt > Count) throw new ArgumentException(""index and count do not denote a valid range of elements in the List."");
            int offset = (index << 2);
            int size = -(count << 2);
        ...
        /// </summary>
        /// <p");
source.Append(@"aram name=""value"">The List{int} instance.</param>
        ...
        public unsafe static implicit operator intListAccessor(List<int> value)
        {
            ...
            else
            {
                *(int*)targetPtr = 0;
                t");
source.Append(@"argetPtr += sizeof(int);
            }
