...
source.Append(@"umentNullException"">
        ///     source or func is null.
        /// </exception>
        /// 
...
source.Append(@"     ///
        ...
        ///     A func");
source.Append(@"tion to test each element for a condition.
        /// </param>
        /// 
        /// <returns>
...
source.Append(@" {
        ...
        /// <returns>
        ///     The input");
source.Append(@" sequence typed as <see cref=""System.Collections.Generic.IEnumerable{T}""/>.
        /// </returns>
...
source.Append(@".OverflowException"">
...
source.Append(@"ce, float?> selector)
        {
            return m_accessor_selector.Average(selector);
        }
        /// 
...
");
source.Append(@"        ///     by invoking a transform function on each element of the input sequence.
        /// </summary>
        /// 
        /// <param name=""selector"">
        ///     A transform function to apply to each element.
...
source.Append(@"e, bool> predicate) { return m_accessor_selector.Count(predicate); }
        ///
        /// <summary>
        ...
        /// <returns>
      ");
source.Append(@"  ///     The first element in the sequence that passes the test in the specified predicate
        ///     function.
        /// </returns>
        /// 
        /// <exception cref=""System.ArgumentNullException"">
        ...
        /// 
        /// <exception c");
source.Append(@"ref=""System.ArgumentNullException"">
        ///     source is null.
        /// </exception>
        ...
        /// </exception>
        public TSou");
source.Append(@"rce FirstOrDefault(Func<TSource, bool> predicate)
        {
...
source.Append(@">
 ...
 ");
source.Append(@"       ///     Basic that corresponds to the maximum value in the sequence.
        /// </returns>
        /// 
        /// <exception cref=""System.ArgumentNullException"">
        ///     source or selector is null.
        ...
        /// 
        /// <exception cref=""S");
source.Append(@"ystem.InvalidOperationException"">
        ///     source contains no elements.
        /// </exception>
        public double Max(Func<TSource, double> selector)
        {
...
source.Append(@"      {
        ...
        /// <summary>
        ///     Invokes a transfo");
source.Append(@"rm function on each element of a sequence and returns the
...
source.Append(@" name=""selector"">
        ...
        /// <returns>
");
source.Append(@"        ///     The value of type Nullable{Int64} in C# or Nullable(Of Int64) in Visual Basic
        ///     that corresponds to the maximum value in the sequence.
        /// </returns>
        /// 
        /// <exception cref=""System.ArgumentNullException"">
...
source.Append(@"(selector);
        ...
        ///     Invokes a transform function on each element of a sequence and returns the
        ///  ");
source.Append(@"   minimum System.Double value.
        /// </summary>
        /// 
        /// <param name=""selector"">
        ///     A transform function to apply to each element.
        ...
        /// <param name=""selector"">
        ///     A transfor");
source.Append(@"m function to apply to each element.
        /// </param>
        /// 
        /// <returns>
        ///     The value of type Nullable{Single} in C# or Nullable(Of Single) in Visual
...
source.Append(@"     /// 
        ...
        /// 
        ///");
source.Append(@" <exception cref=""System.ArgumentNullException"">
        ///     source or selector is null.
        /// </exception>
        ...
        /// </exception>
        public int Min(Fun");
source.Append(@"c<TSource, int> selector)
        {
            return m_accessor_selector.Min(selector);
        }
        ///
        ...
        /// <summary>
        ///     Invokes a transf");
source.Append(@"orm function on each element of a sequence and returns the
...
source.Append(@"e to an Trinity.Index.LINQ.ParallelQuery{T},
...
source.Append(@"ame=""collectionSelector""/>.
        /// </typeparam>
        ///
        /// <typeparam name=""TResult"">
...
source.Append(@"lector, resultSelector).AsParallel();
        }
        /// 
        /// <summary>
        ///     Projects each element of a sequence to an Trinity.Index.LINQ.ParallelQuery{T},
...
source.Append(@"ltSelector).AsParallel();
        }
        /// 
        /// <summary>
...
source.Append(@"        /// </summary>
        ...
        /// <returns>
        /// ");
source.Append(@"    The single element of the input sequence that satisfies a condition.
        /// </returns>
        /// 
        /// <exception cref=""System.ArgumentNullException"">
        ///     source or predicate is null.
...
source.Append(@"quence, or default(TSource) if the sequence
        ///     contains no elements.
        /// </returns>
        /// 
        /// <exception cref=""System.ArgumentNullException"">
...
source.Append(@"ified index in the input sequence.
        /// </returns>
        /// 
        /// <exception cref=""System.ArgumentNullException"">
        ///     source is null.
...
source.Append(@"s>
        ...
        ///     A Trinity.Index.LINQ.PLINQWrapper{T} that contains the elements from
        ");
source.Append(@"///     the input sequence starting at the first element in the linear series that
        ///     does not pass the test specified by predicate.
        /// </returns>
        /// 
        /// <exception cref=""System.ArgumentNullException"">
...
source.Append(@"/ 
        ...
        /// <exception cref=""System.ArgumentNullException"">
        ///     sourc");
source.Append(@"e or selector is null.
        /// </exception>
        /// 
        /// <exception cref=""System.OverflowException"">
        ///     The sum is larger than System.Decimal.MaxValue.
...
source.Append(@"c<TSource, double?> selector)
        {
            return m_accessor_selector.Sum(selector);
        }
        /// 
        ...
        ///    ");
source.Append(@" obtained by invoking a transform function on each element of the input sequence.
        /// </summary>
        /// 
        /// <param name=""selector"">
        ///     A transform function to apply to each element.
...
source.Append(@">
        ...
        /// <exception cref=""System.OverflowException"">
        ///     The sum ");
source.Append(@"is larger than System.Int32.MaxValue.
        /// </exception>
        public int Sum(Func<TSource, int> selector)
        {
            return m_accessor_selector.Sum(selector);
        ...
        /// </exception>
        public long? Sum(F");
source.Append(@"unc<TSource, long?> selector)
        {
            return m_accessor_selector.Sum(selector);
        }
        ///
...
source.Append(@"       }
        ...
        /// <param name=""predicate"">
        ///     A functi");
source.Append(@"on to test each element for a condition.
        /// </param>
        /// 
        /// <returns>
        ///     A Trinity.Index.LINQ.PLINQWrapper{T} that contains the elements from
...
source.Append(@"ion; the second parameter
        /// </param>
        ///     of the function represents the index of the source element.
        /// 
        /// <returns>
...
source.Append(@" <returns>
        ...
        /// <returns>
        ///     ");
source.Append(@"A Trinity.Index.LINQ.PLINQWrapper{T} that contains elements from
        ///     the input sequence that satisfy the condition.
        /// </returns>
        /// 
        /// <exception cref=""System.ArgumentNullException"">
...
source.Append(@"ummary>
        ...
        /// !Not implemented
        public I");
source.Append(@"OrderedEnumerable<TSource> OrderBy<TKey>(Func<TSource, TKey> keySelector)
        {
            throw new NotImplementedException();
        }
        ///
...
source.Append(@"lections.Generic.IEqualityComparer{T}
        ///     to compare values.
        /// </summary>
...
source.Append(@"
        ...
        ///     Groups the elements of a sequence according to a specified key selector function
 ");
source.Append(@"       ///     and creates a result value from each group and its key.
        /// </summary>
        ...
        /// </summary>
     ");
source.Append(@"   public IEnumerable<IGrouping<TKey, TSource>> GroupBy<TKey>(Func<TSource, TKey> keySelector, IEqualityComparer<TKey> comparer)
        {
            throw new NotImplementedException();
        }
        ///
        ...
        ///     group are projected ");
source.Append(@"by using a specified function.
        /// </summary>
        ...
        ///     Groups the elements of a sequence according to a specified key selector function
    ");
source.Append(@"    ///     and creates a result value from each group and its key. Key values are compared
...
source.Append(@"lt> resultSelector)
        {
            throw new NotImplementedException();
        }
        ///
        ...
        {
            throw ");
source.Append(@"new NotImplementedException();
        }
        /// <summary>
...
source.Append(@"nts of two sequences based on matching keys. A specified
        ...
        ///     Performs a subsequent ordering of the elements in a sequence in ascending
        ///  ");
source.Append(@"   order by using a specified comparer.
        /// </summary>
        /// !Not implemented
...
source.Append(@" key selector and element selector functions.
        /// </summary>
        /// !Not implemented
...
source.Append(@"key selector function, a comparer, and an element
        ///     selector function.
        /// </summary>
        /// !Not implemented
...
source.Append(@">(Func<TSource, TKey> keySelector)
        {
            throw new NotImplementedException();
        }
        ///
...
source.Append(@"        throw new NotImplementedException();
        ...
        /// <summary>
        ///     Produces th");
source.Append(@"e set union of two sequences by using a specified System.Collections.Generic.IEqualityComparer{T}.
        /// </summary>
        /// !Not implemented
