...
string module_content = Modules.CommunicationSchemaModule((node->serverList)[iterator_1], module_ctx);
...
string module_content = Modules.CommunicationSchemaModule((node->proxyList)[iterator_1], module_ctx);
    source.Append(module_content);
}
}
source.Append(@"
...
string module_content = Modules.CommunicationSchemaModule((node->moduleList)[iterator_1], module_ctx);
    source.Append(module_content);
}
}
source.Append(@"
