...
source->append(R"::(
{
    ...
    public unsafe class StringAccessor : IAccessor, IEnumerable<char>
    {
        ...
        /// </summary>
        /// <returns>Elements compactly a)::");
source->append(R"::(rranged in a byte array.</returns>
        ...
        #endregion
        /// <summary>
        /// Gets the Char object at a)::");
source->append(R"::( specified position in the current String object.
        /// </summary>
...
source->append(R"::(rent()
        ...
        /// </summary>
        /// <param name="accessor">The String)::");
source->append(R"::(Accessor instance.</param>
...
source->append(R"::(    /// <summary>Determines whether the specified StringAccessor and string have different values.</summary>
        ...
        /// <returns>true if obj is a StringAccessor and its value is the same as this instance; otherwise, false.</retur)::");
source->append(R"::(ns>
